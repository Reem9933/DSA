...
with open('flag.txt','r') as f:
	...
	d=int(d,16)
	x, y = generate_keys(g, p, q,d)
	text = "Some Secret Message that has no value"
	M = str.encode(text, "ascii")
	r1, s1 = sign(M, p, q, g, x)
	if verify(M, r1, s1, p, q, g, y):
		print('All ok')
